...
const orders = [
  {
    ...
    items: [
      ...
      { name: "Fries", quantity: 1, price: "LKR 500.00" },
    ],
    total: "LKR 900.00",
    status: "In Progress",
    deliveryTime: "30-40 min",
    address: "111/A/9 Araliya Uyana Angunawala,Peradeniya",
  ...
  },
  {
    ...
    items: [
      { name: "Pepperoni Pizza", quantity: 1, price: "RS 1500.00" },
      { name: "Garlic Knots", quantity: 1, price: "RS 500.00" },
    ],
    total: "LKR 2000.00",
    status: "Delivered",
  ...
  },
  {
    ...
    items: [
      { name: "Kottu Roti (Chicken)", quantity: 1, price: "LKR 1200.00" },
      { name: "Ice Milo", quantity: 1, price: "LKR 350.00" },
    ],
    total: "LKR 1550.00",
    status: "In Progress",
    deliveryTime: "30-40 min",
  ...
  {
    id: "ORD-004",
    restaurantName: "Pizza Hut - Nugegoda",
    items: [
      {
        name: "Devilled Chicken Pizza (Large)",
        quantity: 1,
        price: "LKR 2750.00",
      },
      { name: "Cheesy Garlic Bread", quantity: 1, price: "LKR 650.00" },
    ],
    total: "LKR 3400.00",
    status: "Delivered",
    deliveryTime: "Delivered at 2:30 PM",
